// Service worker simples — cacheia o "app shell" pra abrir mais rápido
// e funcionar minimamente offline. Os dados (tarefas, pontos, etc.)
// sempre vêm do Supabase, então é preciso internet pra sincronizar.
